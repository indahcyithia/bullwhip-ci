...
<div class="container-fluid">
	<div class="col-md-7 col-md-offset-2">
		<form class="form-horizontal" method="post" action="<?= base_url('/Admin/SavePegawai') ?>">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input required type="password" class="form-control" id="password" placeholder="password input disini" name="password">
				</div>
			</div>
			<br>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input required type="text" class="form-control" id="nama_pegawai" placeholder="nama pegawai input disini" name="nama_pegawai">
				</div>
			</div>
			<br>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input required type="text" class="form-control" id="alamat_pegawai" placeholder="alamat pegawai input disini" name="alamat_pegawai">
				</div>
			</div>
			<br>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input required type="text" class="form-control" id="handphone_pegawai" placeholder="nomor handphone pegawai input disini" name="hp_pegawai">
				</div>
			</div>
			<br>
